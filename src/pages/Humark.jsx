...
function Humark() {
  return (
    <div className="font-BrOmega scroll-smooth">
        <Navbar />
        <main className="pt-12 scroll-smooth">
            ...
            <div className="grid md:grid-cols-2 gap-x-2 sm:gap-x-4 md:gap-x-8">
                <div className="">
                    ...
                    <a href="#diveIn" className='scroll-smooth'><button className="bg-blue-600 text-white rounded px-6 py-3">Dive in</button></a>
                </div>
                <img className='hidden md:block w-full max-w-md mx-auto' src={People} alt="" />
            </div>
            </section>
            <section id='diveIn' className="grid sm:grid-cols-2 gap-5 sm:gap-8 md:gap-20 py-16 sm:px-16 md:px-24">
