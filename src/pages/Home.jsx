    ...
    <div className="font-BrOmega">
        ...
        <main>
            ...
            <section className="h-screen flex flex-col px-[10%] mx-auto justify-center items-center space-y-5 sm:space-y-6 md:space-y-7">
                    ...
                    <h1 className="text-5xl mt-16 sm:text-6xl md:text-7xl md:max-w-2xl mx-auto text-center font-bold">Create the life you want <span className="decoration-underline underline underline-offset-4 decoration-blue-500">now.</span></h1>
                    ...
                    <button className="bg-blue-500 text-white rounded px-6 py-3 hover:bg-blue-600 transition-all ">Get started</button>
            ...
            <section className="bg-blue-50 px-12 py-16 sm:px-16 md:px-24 md:grid md:grid-cols-2 md:gap-12 lg:gap-24 md:items-center">
                ...
                <div className="order-first md:space-y-6">
                    ...
                    <Link to="/humark" className="bg-blue-500 text-white rounded px-6 py-3 block w-fit hover:bg-blue-600 transition-all ">Learn about Humark
                    </Link>
            ...
            <section className="px-12 py-16 sm:px-16 md:px-24 md:grid md:grid-cols-2 md:gap-12 lg:gap-24 md:items-center">
                ...
                <div className="md:space-y-6">
                    ...
                    <button className="bg-blue-500 text-white rounded px-6 py-3 mt-6 flex items-center hover:bg-blue-600 transition-all">Get started <img className="ml-2 w-3" src={Arrow} alt="" /></button>
                </div>
            </section>
            ...
            <section className="bg-orange-50 px-12 py-16 sm:px-16 md:px-24 md:grid md:grid-cols-2 md:gap-12 lg:gap-24 md:items-center">
                ...
                <div className="order-first md:space-y-6">
                    ...
                    <button className="bg-blue-500 text-white rounded px-6 py-3 mt-4 flex items-center hover:bg-blue-600 transition-all">Get started <img className="ml-2 w-3" src={Arrow} alt="" /></button>
                </div>
            </section>
